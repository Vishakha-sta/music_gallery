<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($numExistRows>0){
			...
			$destfile = 'image/profile_photo/icon.png';
			
			// echo  $_POST['fname']." ".$_POST['lname']." ".$_POST['username'] ." ". $_POST['email']." ".$_POST['password']." " . $destfile ;
            
			$sql = "INSERT INTO `users`( `fname`, `lname`, `username`, `email`, `password`,`photo`) VALUES ('$fname','$lname','$username','$email','$password','$destfile')";
            ...
            if($result){
				...
				echo '<script>alert("Result is not inserted inserted");</script>';
        }
    }
?>
<!doctype html>
...
<body>
	<div class="one container my-3" style="width: 600px; height: auto; border-radius:3%;">
		<h1 class="p-2">User Reg<span style="color:blue; font-size:70px;">i</span>ster</h1>
		<hr>
		<form class="g-3 p-2" action="/php/music_gallery/login_system/user_signup.php" method="POST" onsubmit="return checkForm(this);">
			...
			<div class="align-left">
				<p>Already signed up? <a href="user_login.php">Login</a>.</p>
			</div>
			<center>
