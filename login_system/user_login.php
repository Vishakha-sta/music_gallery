    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        if($result->num_rows == 1){
			while($row = $result->fetch_assoc()){
				...
				// echo $_SESSION['username'] ." ". $_SESSION['fname']  ." ". $_SESSION['lname']  ." ".  $_SESSION['email'] ." ". $_SESSION['userid'] ." ". $_SESSION['photo'];
...
<body>
	<div class="one container my-3" style="width: 600px; height: auto; border-radius:3%;">
		<h1 class="p-2">User Login</h1>
		<hr>
		<form class="g-3 p-2" action="/php/music_gallery/login_system/user_login.php" method="POST" onsubmit="return checkForm(this);">
