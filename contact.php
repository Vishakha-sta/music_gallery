            ...
            <div class="row" style="margin-bottom: 20px;">
                ...
                <div class="col-12 col-md-6">
                    <div class="contact-information">
                        ...
                        <h5>Spotify: musicplaylist.spotify.com</h5>
                        <h5>Email: musicplaylist@gmail.com </h5>
                        <h5>Gaana: musicplaylist.gaana.com</h5>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="contact-form">
                        <div class="contact-heading">
                            ...
                            <h5>Don't hesitate to give your feedback</h5>
                        </div>
                        <!-- Form -->
